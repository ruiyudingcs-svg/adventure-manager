...
- `docs/03_godot_architecture.md` 第 4—7、13、15—16 节
- `docs/04_data_model.md` 第 1—2、5 节
- `docs/15_staged_contract_resolution_rules.md` 第 4—5、9 节
- `docs/19_content_catalog_state_and_situation_rules.md` 第 1—3、8 节
...
- 字段与 `docs/04_data_model.md` 对应，不保存执行字符串。
