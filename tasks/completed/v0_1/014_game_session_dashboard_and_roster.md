...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 4—6、10、13 节
- `docs/rules/02_core_loop_and_rules.md` 第 2、10、12—14 节
- `docs/architecture/03_godot_architecture.md` 第 4、6—11、16 节
- `docs/architecture/04_data_model.md` 全部静态/运行时状态与 ViewData 相关章节
