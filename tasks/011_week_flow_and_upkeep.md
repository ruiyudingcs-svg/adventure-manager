...
`docs/20_weekly_upkeep_and_history_rules.md`。实现必须使用其中固定的：
...
- 根目录 `AGENTS.md`
- `docs/01_v0.1_product_spec.md` 第 4、6 节
- `docs/02_core_loop_and_rules.md` 第 2、9、10.4、12—14 节
- `docs/03_godot_architecture.md` 第 5、7—8、12—16 节
- `docs/04_data_model.md` 第 3、4.1—4.5、4.10 节
...
- `docs/19_content_catalog_state_and_situation_rules.md` 第 5—7 节
