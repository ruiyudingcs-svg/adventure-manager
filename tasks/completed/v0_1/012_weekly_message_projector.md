...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 5.3、10 节
- `docs/rules/02_core_loop_and_rules.md` 第 10.5、14 节
- `docs/architecture/03_godot_architecture.md` 第 7—11、13 节
- `docs/architecture/04_data_model.md` 第 3.11—3.12、4.1—4.2 节
- `docs/rules/campaign/11_contract_proposal_generation.md` 第 8 节
- `docs/rules/campaign/13_unhandled_contract_and_npc_results.md` 第 7 节
- `docs/rules/campaign/14_week_flow_faction_commitments_and_messages.md` 第 7—10 节
