...
- 根目录 `AGENTS.md`
- `docs/rules/02_core_loop_and_rules.md` 第 2、7、9—14 节
- `docs/architecture/03_godot_architecture.md` 第 5、7—8、13、16 节
- `docs/architecture/04_data_model.md` 第 3、4.1—4.2、4.10 节
- `docs/rules/contracts/15_staged_contract_resolution_rules.md` 第 8 节
- `docs/rules/campaign/19_content_catalog_state_and_situation_rules.md` 第 4—5、8 节
