...
- 根目录 `AGENTS.md`
- `docs/01_v0.1_product_spec.md` 第 6—7、9、15 节
- `docs/02_core_loop_and_rules.md` 第 2、10—12 节
- `docs/03_godot_architecture.md` 第 7—8、13、15—16 节
- `docs/04_data_model.md` 第 2.9—2.14、3.5—3.7、4.5 节
- `docs/14_week_flow_faction_commitments_and_messages.md` 第 2、6 节
- `docs/17_dragon_invasion_scenario_spec.md`
- `docs/18_dragon_invasion_problem_and_action_catalog.md`
- `docs/19_content_catalog_state_and_situation_rules.md` 第 6—8 节
