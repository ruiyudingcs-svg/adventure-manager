...
- 根目录 `AGENTS.md`
- `docs/rules/02_core_loop_and_rules.md` 第 3—7 节
- `docs/architecture/03_godot_architecture.md` 第 4、5、12、13、15 节
- `docs/architecture/04_data_model.md` 第 1、2.1—2.3、3.3、4.1 节
- `docs/rules/contracts/15_staged_contract_resolution_rules.md` 第 4 节的 seed 要求
...
- Definition 与 State 字段遵循 `docs/architecture/04_data_model.md`，Definition 在运行时只读。
...
- 字段与 `docs/architecture/04_data_model.md` 第 4.1 节一致。
