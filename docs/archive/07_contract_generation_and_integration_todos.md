...
正式规范：`docs/rules/contracts/08_contract_clause_spec.md`。
...
正式规范：`docs/rules/campaign/12_contract_instantiation_and_commitment.md`。
...
正式规范：`docs/rules/campaign/13_unhandled_contract_and_npc_results.md`。
...
正式规范：`docs/rules/campaign/14_week_flow_faction_commitments_and_messages.md`。
...
正式规范：`docs/rules/contracts/15_staged_contract_resolution_rules.md`。
...
正式计划：`docs/content/dragon_invasion/16_dragon_invasion_scenario_content_plan.md`。
...
已完成：见 `docs/content/dragon_invasion/17_dragon_invasion_scenario_spec.md` 第 2—4 节。

### [x] TODO 21C：三个阵营目标树

为每个阵营定义一个最终目标、成功与受阻条件、3 至 5 个小目标，以及它们与钟、问题、合同和直接行动的关系。

已完成：见 `docs/content/dragon_invasion/17_dragon_invasion_scenario_spec.md` 第 5 节。

### [x] TODO 21D：五条进度钟完整规格

确定每条钟的语义、初值、被动变化、生产者、抑制者、关键阈值、可见解释以及阶段、问题和结局用途。

已完成：见 `docs/content/dragon_invasion/17_dragon_invasion_scenario_spec.md` 第 6 节。

### [x] TODO 21E：世界问题图

把九个问题锚点补成完整 WorldProblemDefinition，固定激活、紧迫度、期限、解决、恶化、事件和后续解锁。

已完成：见 `docs/content/dragon_invasion/18_dragon_invasion_problem_and_action_catalog.md` 第 2—4 节。

### [x] TODO 21F：阵营直接行动目录

补齐三个阵营的 weekly_action_table，覆盖所有非结局阶段，并完成目标、问题、target lock、influence、效果和合同复用关系。

已完成：见 `docs/content/dragon_invasion/18_dragon_invasion_problem_and_action_catalog.md` 第 5—9 节。
...
已完成：合同目录见 `docs/content/contracts/09_contract_template_catalog.md`，覆盖审计与路径校准见 `docs/content/dragon_invasion/18_dragon_invasion_problem_and_action_catalog.md` 第 10—12 节。
