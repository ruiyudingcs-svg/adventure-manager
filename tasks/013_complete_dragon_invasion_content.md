...
仍由 `docs/10_baseline_contracts.md` 负责，golden 变化必须另行人工批准。

## Required reading

- 根目录 `AGENTS.md`
- `docs/01_v0.1_product_spec.md` 第 5、7、9—13 节
- `docs/04_data_model.md` 全部 Definition 与验证章节
- `docs/09_contract_template_catalog.md`
