...
状态：Feature Complete / Release Validation（功能实现与自动验证完成；手工整局与 Windows 导出模板待验收）
...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 全文，特别是第 3、5、11、13 节
- `docs/architecture/03_godot_architecture.md` 第 15—17 节
- `docs/product/05_vertical_slice_roadmap.md` Milestone 5
- `docs/rules/contracts/10_baseline_contracts.md`
- `docs/content/dragon_invasion/17_dragon_invasion_scenario_spec.md`
- `docs/content/dragon_invasion/18_dragon_invasion_problem_and_action_catalog.md` 第 11 节
...
- [ ] Windows Debug/Release 导出可启动并完成至少两周。

## Feature completion decision — 2026-07-26

V0.1 产品规格和本任务授权范围内没有剩余功能项。结局、引导、错误状态、平衡审计、
导出 preset 和自动回归均已落地。尚未勾选的项目是发布环境与人工可用性验收，不应被
误报为已通过，也不构成继续增加 V0.1 功能的授权。验收发现的阻断问题应作为最小
bug-fix 处理；新系统、新内容和体验扩展进入后续版本评估。
