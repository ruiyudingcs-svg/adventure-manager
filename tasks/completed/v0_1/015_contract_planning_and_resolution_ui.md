...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 5.3、7.5—8、10、13 节
- `docs/rules/02_core_loop_and_rules.md` 第 4—8、10、12、14 节
- `docs/architecture/03_godot_architecture.md` 第 7—13、16 节
- `docs/architecture/04_data_model.md` Contract Offer/Plan/Resolution 与结果类型
