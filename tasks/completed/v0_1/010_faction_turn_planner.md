...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 7.4—7.7 节
- `docs/rules/02_core_loop_and_rules.md` 第 10.2—10.5、12 节
- `docs/architecture/03_godot_architecture.md` 第 5、7—8、12—13 节
- `docs/architecture/04_data_model.md` 第 2.8、2.10—2.12、3.8—3.9、4.3—4.4 节
...
- `docs/rules/campaign/14_week_flow_faction_commitments_and_messages.md` 第 1、3—5、10—11 节
- `docs/content/dragon_invasion/18_dragon_invasion_problem_and_action_catalog.md` 第 2、5—9 节
