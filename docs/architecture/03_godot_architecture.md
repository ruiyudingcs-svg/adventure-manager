...
完整边界见 `docs/rules/campaign/19_content_catalog_state_and_situation_rules.md`。
...
`docs/rules/campaign/22_campaign_bootstrap_forecast_and_ui_shell.md` 第 4、6 节。
...
`tasks/completed/v0_1/016_save_service_and_round_trip.md`。
