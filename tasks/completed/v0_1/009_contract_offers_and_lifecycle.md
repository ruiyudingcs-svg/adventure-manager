...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 4、7.4—7.7 节
- `docs/rules/02_core_loop_and_rules.md` 第 10.3、12 节
- `docs/architecture/03_godot_architecture.md` 第 5、7—8、12—13 节
- `docs/architecture/04_data_model.md` 第 2.5、3.1、3.8、3.10—3.11、4.1—4.4 节
- `docs/rules/campaign/11_contract_proposal_generation.md`
- `docs/rules/campaign/12_contract_instantiation_and_commitment.md`
- `docs/rules/campaign/13_unhandled_contract_and_npc_results.md` 第 2—4、6—8 节
- `docs/rules/campaign/19_content_catalog_state_and_situation_rules.md` 第 2、5—7 节
