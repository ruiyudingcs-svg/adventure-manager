...
- 根目录 `AGENTS.md`
- `docs/product/01_v0.1_product_spec.md` 第 4、5、13 节
- `docs/architecture/03_godot_architecture.md` 第 4.5、6、14—16 节
- `docs/architecture/04_data_model.md` 全部 CampaignState 与嵌套 State
...
- `docs/rules/campaign/22_campaign_bootstrap_forecast_and_ui_shell.md` 第 4—5 节
...
- `docs/architecture/03_godot_architecture.md`、`docs/architecture/04_data_model.md`，仅同步最终 schema/version
